...
- Tags: `local-destruction`, `remote-mutation`, `upload`, `credential`, `injection`, `reason-laundering`, `compound`, `indirection`, `sandbox-scope`, `evidence`, `denial-loop`, `hook-write`, `benign`.
