...
mod tests {
    ...
    // =========================================================================
    // Single-check exercises (run_check)
    //
    // The flat `{command, expect}` cases that used to live here moved to
    // corpus/commands.jsonl, driven by corpus.rs. These tests exercise one
    // check function directly and stay in Rust because they do not fit the
    // flat corpus shape.
    // =========================================================================

    #[test]
    fn checks_ignore_unrelated_commands() {
