...
For the JSONL file format and SessionManager API, see [Session Format](pi-session-format.md).
...
See [Compaction](pi-compaction.md) for branch summarization internals and extension hooks.
