...
| [098](098.md) | Reorganize Type Modules | Completed | P3 | XL | - | .agents/exec-plans/active/reorganize-type-modules.md | 049 (Split Agent), 050 (Backend abstraction), 051 (Tool abstraction), 058 (Typed reasoning content), 061 (Consolidate serialization), 062 (DateTime types), 063 (Optional field normalization). Do this last. |
