...
These docs are short, agent-facing checklists for risky change surfaces. Read the one routed by `AGENTS.md`, then use the linked design docs for deeper context.
