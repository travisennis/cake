...
- [x] (2026-09-01) Extended discovery to append the active project's `.cake/tools` directory after configured sources, while preserving explicit empty-`CAKE_TOOLBOX` semantics, `--worktree` anchoring, and read-only exclusion.
