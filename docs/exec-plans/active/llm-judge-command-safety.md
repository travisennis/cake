...
- [ ] Milestone 6: judge blocks and fail-closed denials in `task_complete.permission_denials` (#123); metadata-only judge telemetry events and counters (#66, delivered with Milestone 5).
