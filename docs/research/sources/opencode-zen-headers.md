...
The official opencode CLI sends these headers when calling Zen: - x-opencode-client: "cli" - x-opencode-session: <random-id> - x-opencode-project: <random-id> - x-opencode-request: <random-id> - User-Agent: "opencode/latest/1.3.15/cli"
