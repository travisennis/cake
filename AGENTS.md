...
7. If work is managed, track it in a GitHub issue: set Status to In Progress when you start, and follow the issue lifecycle in [docs/workflow/tasks.md](docs/workflow/tasks.md).
...
- The issue lifecycle (when acceptance notes are marked and when the issue closes) is defined in [docs/workflow/tasks.md](docs/workflow/tasks.md); issue state, links, and sub-issues are the managed record.
